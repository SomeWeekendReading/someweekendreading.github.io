...
<!--
## Addendum 2024-Oct-11: Ballot Accepted

<img src="{{ site.baseurl }}/images/***" width="400" height="***" alt="Ballot officially accepted for counting" title="Ballot officially accepted for counting" style="float: right; margin: 3px 3px 3px 3px; border: 1px solid #000000;">
Finally, after a couple days, the Secretary of the Commonwealth's web site says my ballot
