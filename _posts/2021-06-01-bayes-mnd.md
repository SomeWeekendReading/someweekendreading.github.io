...
signnificantly more money back then than it is now!  According to the 
[Bureau of Labor Statistics CPI inflation calculator](https://www.bls.gov/data/inflation_calculator.htm),
\$1 million in 1996 is about \$1.7 million in mid-2021.)  
...
<!-- *** NB: the dollar signs aren't being escaped, but are generating math here?! -->
