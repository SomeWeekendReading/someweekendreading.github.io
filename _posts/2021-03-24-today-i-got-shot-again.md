...
My reaction so far has been pretty reasonable: pain at the injection site (upper left arm,
and stronger than with the first dose), fatigue, mild sense of less control over body
temperature, and so on.  Not being able to use my left arm much is slightly annoying, but
other than that, nothing worse than "slightly annoying".  Gratifyingly, no return of the
...
world-wide who read this crummy little blog, wondered whether pre-dosing with NSAIDs to
blunt the after-vaccination blahs would be ok.  

The answer appears to be: no, please don't do that.  

<img src="{{ site.baseurl }}/images/2021-03-24-today-i-got-shot-again-ucdavis.jpg" width="400" height="146" alt="UC Davis: don't use OTC pain relievers before COVID-19 vaccination" title="UC Davis: don't use OTC pain relievers before COVID-19 vaccination" style="float: right; margin: 3px 3px 3px 3px; border: 1px solid #000000;"/>
Some public-facing advice from UC Davis Health Center <sup id="fn2a">[[2]](#fn2)</sup>
says that it's a bad idea to use NSAIDs before vaccination, but it's ok to do so as needed
_after_ any reaction sets in the next day:  
> Don't medicate with over-the-counter pain relievers before coming in for your shot. We
> don't know yet what impact that might have on your vaccine-induced antibody response.  
> &hellip;  
> After your vaccination, it's OK to take over-the-counter pain relievers if you need them
> for a headache, mild fever or any other discomforts.  

<img src="{{ site.baseurl }}/images/2021-03-24-today-i-got-shot-again-chen-1.jpg" width="500" height="344" alt="Chen, et al.: NSAIDs impair systemic IgM and IgG antibodie responses (but not adaptive)" title="Chen, et al.: NSAIDs impair systemic IgM and IgG antibodie responses (but not adaptive)" style="float: right; margin: 3px 3px 3px 3px; border: 1px solid #000000;"/>
<img src="{{ site.baseurl }}/images/2021-03-24-today-i-got-shot-again-chen-2.jpg" width="500" height="662" alt="Chen, et al.: NSAIDs impair induction of proinflammatory cytokines" title="Chen, et al.: NSAIDs impair induction of proinflammatory cytokines" style="float: right; margin: 3px 3px 3px 3px; border: 1px solid #000000;"/>
A more formal scientific publication in _Journal of Virology_ by Chen, 
_et al._ <sup id="fn3a">[[3]](#fn3)</sup> supports this quantitatively, especially in
Figures 6 &amp; 7:  
> NSAID treatment impairs systemic neutralizing antibody responses to SARS-CoV-2.  
> &hellip;
> NSAID treatment dampens the induction of proinflammatory cytokines that are upregulated
> by SARS-CoV-2 infection in mice.  

They tested both ibuprofen and meloxicam (another NSAID used in arthritis pain), looking
...
Finally, an interview with physicians from the Cleveland Clinic <sup id="fn6a">[[6]](#fn6)</sup>
...
<a id="fn4">4</a>: D Sparks, ["Side effects – or lack of side effects – after being vaccinated for COVID-19"](https://newsnetwork.mayoclinic.org/discussion/side-effects-or-lack-of-side-effects-after-being-vaccinated-for-covid-19/), _Mayo Clinic News Network_, 2021-Feb-16. [↩](#fn4a)  
