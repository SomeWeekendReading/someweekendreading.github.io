...
- As you can see, the curves for the Senate (green) and Presidency (blue) are sort of
...
<a id="fn3">3</a>: [Weekend Editor](SomeWeekendReadingEditor@gmail.com), ["R script to assess significance and strength of Republican association with US government shutdowns"]({{ site.baseurl }}/assets/2024-03-21-springtime-for-shutdowns.r), _Some Weekend Reading_ blog, 2024-Mar-21.  There is also [a transcript of running this]({{ site.baseurl }}/assets/2024-03-21-springtime-for-shutdown.txt), for you to check that it says what we say it says.[↩](#fn3a)  
