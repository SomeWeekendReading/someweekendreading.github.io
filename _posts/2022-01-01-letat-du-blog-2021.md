...
[goodmath.org](https://www.goodmath.org/), [GaryCornell.com](https://www.garycornell.com/),
...
TankTuck, no nothing. I don't even _have_ social media accounts like that.  The only
things I do are (a) mention it to people in conversation or email _when it’s relevant,_ and
(b) very occasionally leave comments on somebody else’s blog. The linking sites confirm
this, being mostly places I’ve left comments on other blogs and the
...
- Most readers are in the Anglosphere, and use desktops or laptops, a few phones and
  almost no tablets.  I'm vaguely disappointed to have few French readers.  
