...
The rules were a _gemische_ of every possible game, involving flags, balls, decks of
...
variance with their clear legal meaning, and even against common sense.  Somehow, each
...
function, actual death threats to the nice little old retired ladies who are election
workers, and so on.  
...
suspicious that this need comes up so suddenly right before an election.  It still puts an
additional hurdle between voters and voting.  
...
In spite of that, I checked my registration in the most direct way: by actually voting in
a (largely pointless) Democratic primary.  All the races were unopposed within the
Democratic party, with the exception of the delegate to the Governor's Council.  (Like
everybody else, I have no idea what that is.)  
...
- they created slates of false electors to subvert the Electoral College,  
- and finally they engaged in violent insurrection to prevent Congress from tabulating
...
- Do not fail to vote or vote 3rd party; that doesn't send a message beyond "I don't care", and is
...
## Addendum 2024-Aug-12: _The Bulwark_ on Republicans Refusing to Certify Election  
...
_Rolling Stone_ is a source of good political reporting&hellip; but here we are.  

They're aleady identifying voters in each county who could serve as plaintiffs for the
tsunami of election certification lawsuits.  Apparently even President Biden is "not
confident at all" that the transfer of power will be peaceful if Trump loses.  
