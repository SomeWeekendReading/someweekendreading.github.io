...
- Except _then_, the mouseover text (visible here, also) is even better.  Inserting some
  ...
  something essential; if you take it away the very nature of the rest is drastically
  different.  (For example, intelligent deduction is the _sine qua non_ of Sherlock Holmes.
