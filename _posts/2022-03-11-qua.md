...
- Except _then_, the mouseover text (visible here, also) is even better.  Inserting some
  ...
  So this sentence is&hellip; as revoltingly &amp; self-referentially recursive as you think it might be.  Probably a [fixpoint Y combinator](https://en.wikipedia.org/wiki/Fixed-point_combinator) in there somewhere.  
