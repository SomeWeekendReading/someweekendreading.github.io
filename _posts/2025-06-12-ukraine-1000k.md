...
- For a while there appeared to be some evidence that the red dots were supralinear, i.e.,
  ...
  evidence pointing to human wave attacks being at the root of the death rate increase.)  
...
<a id="fn14">14</a>: _Economist_ Staff, ["Putin’s sickening statistic: 1m Russian casualties in Ukrain"](https://archive.ph/g2WRV#selection-1131.56-1145.10), _The Economist_, 2025-Jun-02.  __NB:__ Link goes to an unpaywalled archival page. [↩](#fn14a)  
