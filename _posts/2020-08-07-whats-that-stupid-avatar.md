...
<figure style="float: right; margin: 3px 3px 3px 3px; border: 1px solid #000000; display: inline-block">
  ...
  <figcaption><em>Fig. 1:</em> Expected basins of attraction for Newton root-finding on $f(z) = z^3 - 1$</figcaption>
</figure>
